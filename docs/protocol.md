        # Causalsynth: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/CausalSynth.git

        ## Objective

        CausalSynth integrates causal inference methods into meta-analysis, allowing users to estimate causal effects from observational synthesis using directed acyclic graphs and sensitivity analyses.
        ...
        - Code: https://github.com/mahmood726-cyber/CausalSynth.git
        - Dashboard: https://mahmood726-cyber.github.io/CausalSynth/
